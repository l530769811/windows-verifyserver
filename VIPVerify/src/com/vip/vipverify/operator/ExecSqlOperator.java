...
public class ExecSqlOperator implements DoOperator, Serializable {
	...
	public ExecSqlOperator(String string_sql, MyBaseDataProxy mdb, MessageSpreader message_handler, 
			int message_key_suc,
			int message_key_fail) {
		super();
